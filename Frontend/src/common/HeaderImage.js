                ...
                <div id="carousel-1" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item active">
                            <img src="../images/slide2.jpg" height="400" alt="Image of first carousel"/>
                        ...
                        <div class="item">
                            <img src={require("../images/slide4.jpg")} height="400" alt="Image of second carousel"/>
                            <div class="carousel-caption">
                        ...
                        <div class="item">
                            <img src={require("../images/slide2.jpg")} height="400" alt="Image of third carousel"/>
                            <div class="carousel-caption">
