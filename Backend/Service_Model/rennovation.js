...
const rennovation_schema = new schema({
    ...
    zipcode: {type :Number,required:true ,minlength:6,maxLength:6},
    email: {type :String,required:true,unique:true },
    skill:{type :String,required:true }

});

module.exports = mongoose.model('Rennovation',rennovation_schema);
